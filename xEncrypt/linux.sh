...
echo "Encrypting Assets (Linux) : Begin"

# Create an uncompressed archive file.
7z a -tzip -p14611769812890929240 -r -mx9 -mm=Deflate -mfb=128 -mpass10 -mmt=on ${BASEDIR}/../Resources/data ${BASEDIR}/../xScripts/ > /dev/null;
